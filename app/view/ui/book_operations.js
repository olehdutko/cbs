/*
 * File: app/view/ui/book_operations.js
...
Ext.define('Borsuko.view.ui.book_operations', {
...
function sendRemoveRequest(){
    ...
    {
            var statusid = cr.items[i].raw.statusid;
            var str_id = cr.items[i].data.id;
            ...
            Ext.Ajax.request({
                ...
                failure: function(form, action) {alert('Помилка при виделенні');}
            });
