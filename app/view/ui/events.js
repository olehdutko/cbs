...
Ext.define('Borsuko.view.ui.events', {
...
function infoRequest (v, params, record) {
	var cr = Ext.getCmp(GridName).getSelectionModel().selected;
	var event_status_id = cr.items[0].raw.event_status_id;
	showInfoDialogForm(event_status_id);
