<html>
<head>
<title>Історія видачі з виробничих фондів</title>
...
$result = mysql_query("SELECT * FROM  Dodano_v_Nariad WHERE Type = 'в.фонди';");
...
echo ("<table width='700' height='128' border='0' align='center' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td height='10' colspan='3'><h3><p align='Center'>Історія видачі з виробничих фондів </p></H3></td>
