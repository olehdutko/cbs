...
$query = "SELECT * FROM Vyplaty WHERE Date BETWEEN ".$date1." AND ".$date2; 
...
echo ("<table width='700' height='128' border='0' align='center' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td height='10' colspan='3'><h3><p align='Center'>Історія виплат</p></H3></td>
...
echo ("<table width='1000' border='3' cellpadding='0' cellspacing='0' align='center'>
  ...
  <tr bgcolor='DDDDDD'>
    <td width='5%'><div align='center'>Номер виплати</div></td>
    ...
    <td width='60%'><div align='center'>Примітка</div></td>
  </tr>");
...
echo ("<tr class='style1'>
	...
	<td width='5%'><div align='center'>".$row['Nomer_Narahuvannia']."</div></td>
    ...
    <td width='60%'><div align='left'>".$row['Prymitky']."</div></td>
  </tr>");
    }
echo ("</table>");
