...
$result = mysql_query("SELECT * FROM vyrobnychiFondy WHERE IsDeleted = '0'");
...
echo ("<table width='1000' border='0' cellpadding='0' cellspacing='0' align='center'>
  <tr bgcolor='#CCCCCC'>
		<td width='100%'><div align='center'>Виробничі фонди</div></td>
  </tr>
  </table>");
...
echo ("<tr class='style1'>
    ...
    <td width='5%'><div align='left'>".$row['ID']."</div></td>
    <td width='10%'><div align='center'>".$row['Model']."</div></td>
	<td width='40%'><div align='center'>".$Description."</div></td>
