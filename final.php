...
$Razom = $razomActiveBezPdv + $razomMontazhBezPdv + $razomWorksBezPdv + $razomOtherBezPdv;
	...
	Echo ("<tr >
		...
		<td align='center'><Strong>".$razomWorksBezPdv." грн.</Strong></td>
	</tr>");
	}
	...
	Echo ("<tr >
		...
		<td align='center'><Strong>".$razomOtherBezPdv." грн.</Strong></td>
	</tr>");
	}

	Echo ("<tr>
		<td align='center'> <Strong>Всього:</Strong></td>
		<td align='center'> <Strong>".round ($Razom, 2)." грн.</Strong></td>
	</tr>
	");  
	echo ("</table>");
